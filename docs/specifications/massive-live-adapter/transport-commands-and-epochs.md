...
| `C5-BOUND-01` | Bound and account raw frame count/bytes, copy at admission, assign per-epoch frame order, drain every admitted frame or fence it explicitly, and treat raw saturation/oversize as epoch loss. Preserve aggregate/control classification before any optional T/Q shedding. | `PG-TAQ-02`, `ARCH-FLOW-01`–`03`, `DTE-EVENT-02`, `DTE-TQ-03`, `LIFE-TQ-03`; v2 queue evidence. |
