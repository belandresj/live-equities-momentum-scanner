...
`C4-RUN-01`, `C4-FAIL-01`, and `C4-PREFIX-END-01`; proposed
`C4-BOUNDED-CANCEL-01`

**Allocated slices:** accepted `C4-S3`, `C4-S5`; proposed, not authorized
`C4-S6`
...
| Proposed cancellation during candidate probe, first pass, manual group, or terminal/suffix scan | Consequential persisted/lifecycle boundary; C12 composition need | Check context at bounded scan/admission boundaries, return no premature handle/end, and route a started source through exactly one C4-owned bounded cancel result. | `P-C4-BOUNDED-CANCEL` after owner approval |
