...
| 10 | [Versioned snapshot API](specifications/versioned-snapshot-api.md) | Detailed contract accepted as the current executable plan after clean focused review. Immutable publication/T/Q schema mapping is the active first slice; loopback HTTP/CORS composition follows sequentially. |
