...
| 4 | [Aggregate replay](specifications/aggregate-replay.md) | Finally accepted 2026-08-09 including the additive requested-end correction. Owns offline downloader/compiler, normalized artifact, deterministic source/clock, shared aggregate path, and full-source-trusted prefix completion with distinct lifecycle/accounting. |
