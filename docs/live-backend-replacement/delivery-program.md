...
| Capability A — canonical state and hydration | `lbr_a1_active` | `LBR-P1` is accepted. Implement only [`LBR-A1`](tickets/lbr-a1-compact-canonical-aggregate-state.md); `LBR-A2` remains inactive. |
