export function snapshotFixture(rowCount = 1) {
  ...
  return {
    ...
    rows,
    accounting: { population: { universe_total: 2, valid_prior_close: 2, invalid_or_missing_prior_close: 0, trusted_rankable_mark: 1, trusted_below_price_mark: 0, no_print_through_t: 1, invalid_mark: 0, unknown_due_failure_or_fence: 0, covered_population: 2, unresolved_population: 0 }, qualification: { not_yet_passed: 1, provisional: 1, finalized: 0, unresolved: 0 }, uncertainty: { bootstrap_origin: 0, post_bootstrap_gap: 0, local_invalid: 0 } },
    recovery: { purpose: "fresh_bootstrap", generation: "1", start: "2026-08-08T15:58:00Z", end: "2026-08-08T15:59:00Z", supported_through: "2026-08-08T15:59:58Z", fence_reconciled: true, policy_waiting: false, work: { planned: "2", open: "0", completed_value: "1", completed_empty: "1", failed: "0", canceled: "0", fenced: "0" }, rows: { consumed: "2", inserted: "1", duplicate: "1", conflict_or_withdrawal: "0", rejected: "0", fenced: "0", integrity: "0" } },
    tq: { desired_symbols: desired, pressure_mode: "normal", aggregate_only: false, shed: false, retained_bound_hit: false, pressure_misses: 0, pressure_transitions: "0", pressure_fenced: "0", known_present: rowCount, known_absent: 0, unknown: 0, retained_trades: rowCount, retained_quotes: rowCount, retained_fingerprints: rowCount, facts: { consumed: "2", applied: "1", duplicate: "1", rejected: "0", fenced: "0", pressure_shed: "0", integrity: "0" }, commands: { issued: "1", pending: "0", acknowledged: "1", failed: "0", fenced: "0", result_fenced: "0" } },
